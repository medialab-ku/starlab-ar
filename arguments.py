...
class Arguments:
    ...
    def add_inversion_args(self):
        ...
        self._parser.add_argument('--registration', action='store_true', default=False, help='')
        self._parser.add_argument('--GAN_ckpt_path', type=str, default='./saved_results/CRN_GAN_can', help='GAN Checkpoint path.')
        self._parser.add_argument('--GAN_ckpt_save', type=str, default='GAN_can_ckpt_', help='GAN(D + G) Checkpoint name to save.')
        self._parser.add_argument('--GAN_save_every_n_data', type=int, default=0, help='save GAN models every n datas')
