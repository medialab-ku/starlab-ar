...
class DemoOptions():
    ...
    def __init__(self):
        ...
        # default_checkpoint_body_smpl ='./extra_data/body_module/pretrained_weights/hrnet/bedlam_cliff_3dpw_ft.ckpt'
        # default_checkpoint_body_smpl ='./extra_data/body_module/pretrained_weights/resnet_hmr/resnet_cliff_ft_3dpw.ckpt'
        default_checkpoint_body_smpl ='./extra_data/body_module/pretrained_weights/convnext_hmr.ckpt'
        # default_checkpoint_body_smpl ='./extra_data/body_module/pretrained_weights/mocapSPIN.pt'
        ...
        ckpt_posebert_fn ='./extra_data/body_module/pretrained_weights/posebert_smpl.pt'
        parser.add_argument('--ckpt_posebert_fn', required=False, default=ckpt_posebert_fn, help='Path to pretrained checkpoint Posebert')
        ...
        parser.add_argument("--save_frame", default=False, action='store_true', help='Save the extracted frames from video input or webcam')
        ...
        # renderer
        parser.add_argument("--renderer_type", type=str, default="taichi", 
            choices=['taichi', 'pytorch3d', 'opendr', 'opengl_gui', 'opengl'], help="type of renderer to use")
