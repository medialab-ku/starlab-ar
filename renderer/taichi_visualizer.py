...
"""
Renders mesh using Taichi for visualization.
"""
...
g_valid_import_mesh = False
g_valid_import_camera = False
try:
    from .taichi_renderer import TaichiRenderer
    g_valid_visualize = True
except ImportError:
    print("Cannot import Taichi Renderer")
assert g_valid_visualize, "You should import Taichi related modules"

# try:
#     from .taichi_mesh import Mesh
#     g_valid_import_mesh = True
# except ImportError:
#     print("Cannot import Mesh module")
# assert g_valid_import_mesh, "You should import Mesh module"

# try:
#     from .taichi_camera import Camera
#     g_valid_import_camera = True
# except ImportError:
#     print("Cannot import Camera module")
# assert g_valid_import_camera, "You should import Camera module"
...
class Visualizer(object):
    ...
    def __init__(self, renderer_backend):
        ...
        # set-up renderer
        camera = Camera(eye=[0.0, 0.0, 3.0], zn=0.1, zf=10.0)
    ...
    def visualize(self, 
        ...
        if pred_mesh_list is not None:
            print('pred_mesh_list', pred_mesh_list)
