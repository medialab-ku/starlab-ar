...
from bodymocap.models import  OneEuroFilter
...
class BodyPoseEstimator(object):
    ...
    def __init__(self):
        ...
        self.filter_2D = [(OneEuroFilter(**self.filter_config_3d),
    ...
    def detect_body_pose(self, img):
        ...
        for n in range(len(pose_entries)):
            ...
            # t = time.time()
            # for m in range(num_keypoints):
            #     pose_keypoints[m, 0] = self.filter_2D[m][0](pose_keypoints[m, 0], t)
            #     pose_keypoints[m, 1] = self.filter_2D[m][1](pose_keypoints[m, 1], t)
